 ...
 * 
 */
public class BicicletaModelo extends VehiculoModelo{
    ...
    //Método constructor
    public BicicletaModelo() {
    }
    
    //Método constructor con todos los atributos exepto el valor
    public BicicletaModelo(String proposito, String tipoMarco, boolean motor, String tipoMotor, String clase, String marca, String estado, int modelo, String ref, String placa, PersonaModelo dueño, int kmRecorridos, String color, String servicio, int numPasajeros) {
